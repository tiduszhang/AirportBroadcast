        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                .AddItem(new MenuItemDefinition(
                    ...
                    .AddItem(new MenuItemDefinition(
                        "AudioSetsDevice",
                        L("Pages_AudioSets_Device"),
                        url: "audioSetsDevice",
                        icon: "icon-settings",
                        requiredPermissionName: AppPermissions.Pages_AudioSets_Device
                        )
                    )
                    .AddItem(new MenuItemDefinition(
                       "AudioSetsTopPwrPort",
                        L("Pages_AudioSets_TopPwrPort"),
                        url: "audioSetsTopPwrPort",
                        icon: "icon-settings",
                        requiredPermissionName: AppPermissions.Pages_AudioSets_TopPwrPort
                        )
                    )
                );
        }
