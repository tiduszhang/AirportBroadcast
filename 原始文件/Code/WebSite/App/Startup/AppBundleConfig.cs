    ...
    public static class AppBundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new ScriptBundle("~/Bundles/App/libs/js")
                    .Include(
                        ...
                        ScriptPaths.Bootstrap_DateTimePicker_zh,
                        ScriptPaths.Bootstrap_TimePicker,
                         "~/libs/angular-select2/select2.js"
                    ).ForceOrdered()
                );
           ...
           new ScriptBundle("~/Bundles/App/metronic/js")
               .Include(
                   "~/metronic/ttsassets/global/scripts/app.js",
                   "~/metronic/ttsassets/layouts/layout/scripts/layout.js",
                   "~/metronic/ttsassets/layouts/global/scripts/quick-sidebar.js"
               ).ForceOrdered()
           );
            //bundles.Add(
            //  new ScriptBundle("~/Bundles/App/metronic/js")
        ...
        private static void AddAppCssLibs(BundleCollection bundles, bool isRTL)
        {
            bundles.Add(
                new StyleBundle("~/Bundles/App/libs/css" + (isRTL ? "RTL" : ""))
                    ...
                    .Include(StylePaths.Bootstrap_TimePicker)
        ...
        private static void AddAppMetronicCss(BundleCollection bundles, bool isRTL)
        {
            bundles.Add(
             new StyleBundle("~/Bundles/App/metronic/css" + (isRTL ? "RTL" : ""))
                 .Include("~/metronic/ttsassets/global/css/components-md" + (isRTL ? "-rtl" : "") + ".css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .Include("~/metronic/ttsassets/global/css/plugins-md" + (isRTL ? "-rtl" : "") + ".css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .Include("~/metronic/ttsassets/layouts/layout/css/layout" + (isRTL ? "-rtl" : "") + ".css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .Include("~/metronic/ttsassets/layouts/layout/css/themes/darkblue" + (isRTL ? "-rtl" : "") + ".css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .Include("~/metronic/ttsassets/global/plugins/select2/css/select2.min.css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .Include("~/metronic/ttsassets/global/plugins/select2/css/select2-bootstrap.min.css", new CssRewriteUrlWithVirtualDirectoryTransform())
                 .ForceOrdered()
             );
            //bundles.Add(
            //    new StyleBundle("~/Bundles/App/metronic/css" + (isRTL ? "RTL" : ""))
