(function () {
    appModule.controller('common.views.users.createOrEditModal', [
        ...
        function ($scope, $uibModalInstance, userService, userId) {
            ...
            vm.roles = [];
            vm.setRandomPassword = false;//(userId == null);
            vm.sendActivationEmail = false;//(userId == null);
            ...
            vm.save = function () {
                vm.user.emailAddress = vm.user.userName + "@qq.com";
                vm.user.isLockoutEnabled = false;
