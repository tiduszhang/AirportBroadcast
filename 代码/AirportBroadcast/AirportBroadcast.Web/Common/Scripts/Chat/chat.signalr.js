...
(function ($) {
    ...
    var playaudioHub = $.connection.playAudioHub; //get a reference to the hub   
    playaudioHub.client.RefreshData = function (message) {
        abp.event.trigger('app.playaudio.RefreshData', message);      
    };

    playaudioHub.client.RefreshNowPlayAudio = function (message) {
        abp.event.trigger('app.playaudio.RefreshNowPlayAudio', message);
    };
