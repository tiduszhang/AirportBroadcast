(function () {
    //设备管理
    appModule.controller('common.views.play.broadlist.recivelog', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, receiveJson) {
            ...
            vm.showDetails = function (entity) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/play/broadlist/recivelogsDetail.cshtml',
                    controller: 'common.views.play.broadlist.recivelogsDetail as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        content: function () {
