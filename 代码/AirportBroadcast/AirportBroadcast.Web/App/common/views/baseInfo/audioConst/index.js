(function () {
    //设备管理
    appModule.controller('common.views.baseinfo.audioConst.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.audioConst',
        'abp.services.app.commonLookup',
        function ($scope, $uibModal, $stateParams, uiGridConstants, audioConst, commonLookup) {
            var vm = this;
            ...
            vm.getAll = function () {
                vm.loading = true;
                audioConst.getAll(vm.requestParams)
            ...
            function openCreateOrEditModal(entityId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/baseinfo/audioConst/createOrEdit.cshtml',
                    controller: 'common.views.baseinfo.audioConst.createOrEdit as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entityId: function () {
