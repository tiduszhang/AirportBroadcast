(function () {
    //设备管理
    appModule.controller('common.views.baseinfo.audioCheckIn.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.audioCheckIn',
        'abp.services.app.commonLookup',
        function ($scope, $uibModal, $stateParams, uiGridConstants, audioCheckIn, commonLookup) {
            var vm = this;
            ...
            vm.getAll = function () {
                vm.loading = true;
                audioCheckIn.getAll(vm.requestParams)
            ...
            function openCreateOrEditModal(entityId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/baseinfo/audioCheckIn/createOrEdit.cshtml',
                    controller: 'common.views.baseinfo.audioCheckIn.createOrEdit as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entityId: function () {
