...
using AirportBroadcast.Web;

namespace AirportBroadcast.Emailing
{
    public class EmailTemplateProvider : IEmailTemplateProvider, ITransientDependency
    {
        ...
        {
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Ky.SelfEquipmentManager.Emailing.EmailTemplates.default.html"))
            {
