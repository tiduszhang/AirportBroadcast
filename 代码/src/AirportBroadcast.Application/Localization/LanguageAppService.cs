...
using AirportBroadcast.Localization.Dto;

namespace AirportBroadcast.Localization
{
    ...
    public class LanguageAppService : AbpZeroTemplateAppServiceBase, ILanguageAppService
    {
        ...
        public LanguageAppService(
            ...
            IApplicationLanguageTextManager applicationLanguageTextManager, IWavCombine wavCombine,
