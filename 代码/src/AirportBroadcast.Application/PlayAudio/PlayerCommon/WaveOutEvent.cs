...
namespace AirportBroadcast.PlayAudio
{
    ...
    public class WaveOutEvent : IWavePlayer, IWavePosition
    {
        ...
        /// </summary>
        //public int DeviceNumber { get { return WaveInterop.waveOutGetNumDevs(); } }
        public int DeviceNumber { get; set; } = -1;

        public string DeviceName { get; set; }
        public PlayerAgs PlayerAgs
        {
            get { return playerAgs; }
            set { this.playerAgs = value; }
        }
        /// <summary>
        ...
        /// </summary>
        public void Play(PlayerAgs playerAgs)
        {
            this.playerAgs = playerAgs;
