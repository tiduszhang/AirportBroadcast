...
namespace AirportBroadcast.Web.Bundling
{
    public static class ScriptPaths
    {
        ...
        public const string Bootstrap_DateTimePicker = "~/libs/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js";
        public const string Bootstrap_DateTimePicker_zh = "~/libs/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js";
