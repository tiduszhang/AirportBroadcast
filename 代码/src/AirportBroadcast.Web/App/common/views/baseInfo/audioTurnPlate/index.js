(function () {
    //设备管理
    appModule.controller('common.views.baseinfo.audioTurnPlate.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.audioTurnPlate',
        'abp.services.app.commonLookup',
        function ($scope, $uibModal, $stateParams, uiGridConstants, audioTurnPlate, commonLookup) {
            var vm = this;
            ...
            vm.getAll = function () {
                vm.loading = true;
                audioTurnPlate.getAll(vm.requestParams)
            ...
            function openCreateOrEditModal(entityId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/baseinfo/audioTurnPlate/createOrEdit.cshtml',
                    controller: 'common.views.baseinfo.audioTurnPlate.createOrEdit as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entityId: function () {
