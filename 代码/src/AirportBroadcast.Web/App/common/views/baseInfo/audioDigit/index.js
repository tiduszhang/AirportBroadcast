(function () {
    //设备管理
    appModule.controller('common.views.baseinfo.audioDigit.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.audioDigit',
        'abp.services.app.commonLookup',
        function ($scope, $uibModal, $stateParams, uiGridConstants, audioDigit, commonLookup) {
            var vm = this;
            ...
            vm.getAll = function () {
                vm.loading = true;
                audioDigit.getAll(vm.requestParams)
            ...
            function openCreateOrEditModal(entityId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/baseinfo/audioDigit/createOrEdit.cshtml',
                    controller: 'common.views.baseinfo.audioDigit.createOrEdit as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entityId: function () {
