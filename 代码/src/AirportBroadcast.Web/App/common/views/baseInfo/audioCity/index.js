(function () {
    //设备管理
    appModule.controller('common.views.baseinfo.audioCity.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.audioCity',
        'abp.services.app.commonLookup',
        function ($scope, $uibModal, $stateParams, uiGridConstants, audioCity, commonLookup) {
            var vm = this;
            ...
            vm.getAll = function () {
                vm.loading = true;
                audioCity.getAll(vm.requestParams)
            ...
            function openCreateOrEditModal(entityId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/baseinfo/audioCity/createOrEdit.cshtml',
                    controller: 'common.views.baseinfo.audioCity.createOrEdit as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entityId: function () {
